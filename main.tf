  ...
  policy = <<EOF
{
  ...
  },
  {
    ...
    "Action": ["ec2:*"],
    "Resource": "*",
    "Condition": {"StringLike": {"ec2:ResourceTag/verta.ai/managed": "true"}}
  },
  {
    "Sid": "EC2tag2",
    "Effect": "Allow",
    "Action": ["ec2:*"],
    "Resource": "*",
    "Condition": {"StringLike": {"ec2:ResourceTag/kubernetes.io/cluster/verta-mgt-${var.cluster_name}": "owned"}}
  },
  {
    "Sid": "Decode",
    "Effect": "Allow",
  ...
  },
  {
    ...
    "Action": ["iam:*"],
    "Resource": "*",
    "Condition": {"StringLike": {"iam:ResourceTag/verta.ai/managed": "true"}}
  },
  {
